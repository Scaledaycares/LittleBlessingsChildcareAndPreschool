...
function startConversation() {
    fetch('https://chatbot-for-little-blessings-childcare-and-preschool.replit.app/start', {
        method: 'GET'
    })
    .then(response => response.json())
    .then(data => {
...
document.getElementById('chat-form').addEventListener('submit', function(event) {
    ...
    fetch('https://chatbot-for-little-blessings-childcare-and-preschool.replit.app/chat', {
        method: 'POST',
        headers: {
...
function sendToGas4(message, isUserMessage) {
    ...
    const GAS_URL4 = 'https://script.google.com/macros/s/AKfycbwbW_7Zrh4GgfdBOLEO9RnJ4EZIcLehPhIelcreSTX5yPgX3alo_5EXk95qbLGDMe6f/exec';
